...
- prop_library[] 每条必须有：prop_id, name, description, prompt。
- episode_scene_asset_links[] 每行必须有：episode_id, scene_id, scene_set_id, slugline, characters, costume_by_character, props_carried_by_character, scene_props_base。
