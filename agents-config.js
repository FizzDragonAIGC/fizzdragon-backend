  ...
  "characters": [
    {
      ...
      "背景故事": "100-200字的角色背景，包含成長經歷、重要事件",
      
      "G.W.L.T.框架": {
        "ghost": "過去創傷事件：發生了什麼具體事件讓角色變成現在這樣？",
        "wound": "心理傷口：Ghost造成的持續性心理痛苦，外在表現是什麼？",
        "lie": "錯誤信念：角色因為Wound形成的錯誤世界觀（如：我不值得被愛）",
        "truth": "需要學習的真理：故事結束時角色需要領悟的正確信念"
      },
      
      "動機系統": {
        "want": "表面慾望：角色主動追求的外在目標（驅動情節）",
        "need": "深層需求：角色真正需要但不自知的東西（驅動弧線）",
        "conflict": "內在衝突：want和need之間的矛盾"
      },
      ...
      "視覺設計": {
        "silhouette": "圓形（溫和）/方形（穩重）/三角形（危險）",
        "age": "年齡",
        "gender": "性別",
        "height": "身高",
        "build": "體型（瘦削/健壯/豐滿）",
        "face": "眼睛、眉毛、嘴巴、鼻子的具體特徵",
        "hair": "髮型、髮色、特殊造型",
        "服裝風格": "日常穿著、配色、代表性配飾",
        "視覺符號": "代表角色的顏色/物品/圖案"
      },
      
      "ai_prompt": "英文Prompt（80-120詞），包含外貌、表情、服裝、姿態、光線、風格"
    }
  ],
  "relationships": [
    {
